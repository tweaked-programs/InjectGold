...
public class ItemRegister {
    ...
    public static Pair<String, Formatting> getType(String id) {
        if (ItemRegister.meat.get(id)!=null) {
            return new Pair<>("meat", fMeat);
        } else if (ItemRegister.sweet.get(id)!=null) {
            return new Pair<>("sweet",fSweet);
        } else if (ItemRegister.vegan.get(id)!=null) {
    ...
    public static void register() {
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "golden_cake"), new BlockItem(BlockRegister.GOLDEN_CAKE, new FabricItemSettings().group(ItemGroup.FOOD).maxCount(1)));
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "injector_block"), new BlockItem(BlockRegister.INJECTOR_BLOCK, new FabricItemSettings().group(Main.INJECTGOLD_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "groblun"), new BlockItem(BlockRegister.GROBLUN, new FabricItemSettings().group(Main.INJECTGOLD_GROUP)));
